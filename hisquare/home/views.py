...
from home.models import AboutPage, AboutPromotion, Event, ShopCategory, Business, CategoryImage, EventLink
...
def event_serializer(events):
  ...
  for event in raw_data:
    ...
    d['links'].extend( link for links in EventLink.objects.filter(event__pk=d['eid']) )
    actual_data.append(d)
  return actual_data
